        ...
        <div ref={dropdownRef} className="relative">
            ...
            >
                {activeCandidate ? (
                    <>
                        ...
                        <span className="font-semibold max-w-[100px] truncate">{activeCandidate.name}</span>
                    </>
                ) : (
                    <>
                        ...
                        <span className="text-muted font-medium">Select Candidate</span>
                    </>
                )}
            ...
            {isOpen && (
                <div className="absolute top-full right-0 mt-2 w-64 glass rounded-xl shadow-2xl z-50 overflow-hidden">
                    ...
                    <div className="max-h-60 overflow-y-auto">
                        {candidates.map((candidate) => (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-card transition-colors ${candidate.id === activeCandidate?.id ? 'bg-primary/10' : ''
                                    }`}
                            >
                    ...
                    {/* Divider */}
                    {candidates.length > 0 && <div className="border-t border-border" />}

                    {/* Create New Candidate Link */}
                    <Link
