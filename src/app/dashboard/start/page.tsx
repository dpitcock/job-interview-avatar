...
export default function LiveInterviewPage() {
    ...
    const handleStartSession = async () => {
        ...
        await startSession(videoRef.current, {
            ...
            avatarName: activeCandidate?.avatar?.avatarName || 'Wayne_20240711', // User avatar or default
        });
    };
        ...
        try {
            ...
            const fullResponse = await stream(
                [{ role: 'user', content: testText }],
                {
                    ...
                    provider: activeCandidate?.llm?.cloudProvider,
                    model: activeCandidate?.llm?.cloudModel
                }
            );
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted">Real-time AI avatar with voice</p>
                </div>
